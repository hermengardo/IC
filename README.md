...
├── Diários/                                 # Anotações sobre o que foi feito durante o dia               
├── Relatórios/
│   └── relatório_28_07_2025.md              # Rel. de seleção de banco de dados e scripts de processamento
└── Scripts/
    └── 0_db/                                # Seleção de banco de dados e scripts de processamento
